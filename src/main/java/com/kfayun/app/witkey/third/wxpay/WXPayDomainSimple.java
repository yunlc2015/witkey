 ...
 */
public class WXPayDomainSimple {
    private WXPayDomainSimple(){}
    private static class WxpayDomainHolder{
        private static WXPayDomainSimple holder = new WXPayDomainSimple();
    }
    public static WXPayDomainSimple instance(){
