...
import com.kfayun.app.witkey.third.wxpay.WXPayConstants.SignType;
...
//        }
    ...
    public boolean isSignatureValid(Map<String, String> data) throws Exception {
        return WXPayUtil.isSignatureValid(data, config.getMchKey(), this.signType);
    }
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        reqData.put("sign", WXPayUtil.generateSignature(reqData, config.getMchKey(), this.signType));
        return reqData;
    }
    ...
    public boolean isResponseSignatureValid(Map<String, String> reqData) throws Exception {
        ...
        return WXPayUtil.isSignatureValid(reqData, this.config.getMchKey(), this.signType);
    }
    ...
    public boolean isPayResultNotifySignatureValid(Map<String, String> reqData) throws Exception {
        ...
        return WXPayUtil.isSignatureValid(reqData, this.config.getMchKey(), signType);
    }
