    ...
    <div class="manage" style="padding: 15px;">
        <form class="layui-form" method="post">
            ...
            <div class="layui-form-item ">
                ...
                <div class="layui-input-block">
                    <input type="hidden" id="imgpath" name="imgpath" value="${banner.imageUrl!}" />
            			<div style="display:inline;padding-top:10px;" id="coverPicker">上传</div><span id="progress"></span>
                		<br/><img id="imgpath2" src="${banner.imageUrl!}" style="max-width: 500px;" />
                </div>
            </div>
            ...
            <div class="layui-form-item ">
                ...
                <div class="layui-input-block">
                    <input type="text" name="targeturl" required lay-verify="required" placeholder="Url"
                           autocomplete="off" class="layui-input" value="${banner.targetUrl!}">
                </div>
            </div>
            ...
            <div class="layui-form-item ">
                ...
                <div class="layui-input-block">
                    <input type="text" name="sortno" placeholder=""
                           autocomplete="off" class="layui-input" value="${banner.sortNo}">
                </div>
            </div>
...
<@layout.foot>
	...
	<script type="text/javascript">
        ...
        $('#location').val('${banner.location!}');

        layui.use('form', function () {
	        var form = layui.form;
            form.on('submit(save)', function(data) {
                ajaxSubmit('banneredit', data);
                return false;
            });
	    });
