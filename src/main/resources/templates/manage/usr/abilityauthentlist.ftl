...
<@layout.body>
	<div class="place">您所在的位置: 用户管理 - 实力认证列表</div>
	<!-- 内容主体区域 -->
    <div class="manage" style="padding: 15px;">
        ...
        <thead>
            ...
            <tr>
                ...
                <td class="left"><#if authent.authGrade==1 >认证设计师
                ...
                <td>
                    ...
                    <a href="javascript:openDialog('abilityauthentaudit?id=${authent.id?c}', '认证审核', '900px', '720px');" class="layui-btn layui-btn-normal layui-btn-sm">审核</a>
                    <#else>
                    <a href="javascript:openDialog('abilityauthentdetail?id=${authent.id?c}', '认证详情', '900px', '720px');" class="layui-btn layui-btn-normal layui-btn-sm">详情</a>
                    </#if>
                </td>
            </tr>
            </#list>
