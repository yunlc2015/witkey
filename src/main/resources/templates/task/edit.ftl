                ...
                <div class="y-Boxleft">
                    ...
                    <div class="inpBox">
                        ...
                        <ul class="tz-order-upload JsPara">
                            ...
                            <li>
                                <div class="li-con">
                                    ...
                                    <input type="hidden" id="url" value='/task/${file.url}' />
                                </div>
                            </li>
                            </#list>
                        </ul>
                        ...
                        <div class="inp8-box">
                            ...
                            <ul class="tz-inp-box">
                                <li>
                                    <label><input type="radio" name="invest-mode" id="tmode2" value="2">投标模式</label>
                                    <p>先选中标服务商，TA再工作，<br>适合印刷制作、商标注册、网站开发等工作。</p>
                                </li>
                                <li>
                                    <label><input type="radio" name="invest-mode" id="tmode1" value="1">悬赏模式</label>
...
<@layout.foot>
    ...
    <script>
        $(document).ready(function ($) {
            ...
            $("#tmode2").attr("checked", true);
            <#else>
            $("#tmode1").attr("checked", true);
            </#if>
