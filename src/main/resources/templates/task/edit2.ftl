                ...
                <div class="y-Boxleft">
                    ...
                    <div class="inpBox">
                        ...
                        <div class="inp2-box">
                            ...
                            <input type="text" name="requirement" id="requirement" placeholder="例如：新成立的科技公司的LOGO设计" value="${task.requirement}">
                        </div>
                        <div class="inp3-box">
                            <span>需求详情：</span>
                            <p class="textarea-holder"></p>
                            <textarea name="designDetails" id="designDetails">${task.designDetails}</textarea>
                        </div>
                        <div class="inp4-box">
                        ...
                        <!-- 增加 start -->
                        <ul class="tz-order-upload JsPara">
                            ...
                            <li>
                                <div class="li-con">
                                    ...
                                    <input type="hidden" id="url" name="url" value='/task/${file.url}' />
                                </div>
                            </li>
                            </#list>
                        </ul>
                        ...
                        <div class="inp5-box">
                            <div class="inp-kl inp-n">
                                <span>您的需求工作量：</span>
                                <input type="text" name="designContent" id="designContent" placeholder="例如：画册20页或LOGO一个" value="${task.designContent }">
                            </div>
                            <div class="inp-kr inp-n">
                                <span>您的期望时间：</span>
                                <input type="text" name="hopeDays" id="hopeDays" placeholder="7天" value="${task.hopeDays}">
                            </div>
                            <div class="c"></div>
                        </div>
                        ...
                        <div class="inp7-box">
                            <div class="inp-n inp7-k">
                                <span>您的设计预算：</span>
                                <input type="text" name="designBudget" id="designBudget" value="${task.designBudget}" >
                            </div>
                            <em>元</em>
                            <div class="txt jsRadioTxt">
                                <div class="ok">
                                    <p class="blue">启用项目管家您的需求将优先发送给平台实力设计师，任务金额不得低于1000元，项目管家将对出品质量进行全程把控。</p>
                                </div>
                                <div class="unok">
                                    <p class="blue">项目未经过项目管家托管，自由发布，任务金额不得低于50元，平台将对发布项目进行自由匹配。</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="inp8-box">
                            ...
                            <ul class="tz-list2">
                                <li>
                                    <div class="avatar"><a href="/designer/${designer.id}" >
                                        <img src="${designer.avatar!'/lib/images/avatar.jpg'}" alt=""/></a><em>R</em></div>
                                    <div class="txt">
                                        <h4>${designer.nickname} / ${designer.province!} ${designer.city!}" /></h4>
                                        <div class="favor">擅长领域：${designer.special}</div>
                                        <div class="info">
                                            <span class="price">￥${designer.startingPrice}</span>
                                            成交量：${designer.dealCount}笔；　好评数：${designer.goodCount}个
                                        </div>
                                    </div>
                                    <dl class="pic">
                        ...
                        <div class="inp8-box">
                            <div class="inp-n">
                                <span>其它服务（选填）：</span>
                                <input type="text" name="otherService" id="otherService" value="${task.otherService}" >
                            </div>
                        </div>
                        <div class="inp9-box">
                            <div class="p9-rad">
                        ...
                        <div class="jsCheckTxt">
                            <div class="inp10-box">
                                <div class="inp-n">
                                    <span>发票抬头：</span>
                                    <input type="text" name="invTitle" id="invTitle" value="${task.invTitle }" >
                                </div>
                            ...
                            <div class="inp11-box">
                                <div class="inp-n put-w1">
                                    <span>快递地址：</span>
                                    <input type="text" name="invAddress" id="invAddress"  value="${task.invAddress }">
                                </div>
                                <div class="inp-n put-w2">
                                    <span>收件人：</span>
                                    <input type="text" name="invRecipients" id="invRecipients" value="${task.invRecipients }" >
                                </div>
                                <div class="inp-n put-w3">
                                    <span>联系电话：</span>
                                    <input type="text" name="invCellphone" id="invCellphone" value="${task.invCellphone }">
                                </div>
                            </div>
                        </div>
                        <div class="c"></div>
                        ...
                        <input type="hidden" id="designerid" name="desdesignerid" value="${designer.id}" />
...
<@layout.foot>
    ...
    <script>
        $(document).ready(function ($) {
                ...
                if (once == 0) {
                    ...
                    var options = {
                        ...
                        success: function (josn) {
                            ...
                            if (json.data == 1) {
                                location.href = "pay?tradeno=" + json.data;
                            } else if (json.data == 2) {
            ...
            $("#cate").val('${task.cateId}');

            <#if task.getService() == 1 >
